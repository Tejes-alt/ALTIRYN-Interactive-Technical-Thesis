...
import { Environment, Instance, Instances, Lightformer, OrbitControls, PerformanceMonitor, Stars, useTexture } from "@react-three/drei";
...
//#region src/stores/experience.ts
...
//#endregion
//#region src/components/altiryn/three/constants.ts
var SUN_DIR = new THREE.Vector3(-.62, .42, .66).normalize();
var SUN_POS = SUN_DIR.clone().multiplyScalar(46);
var EARTH_RADIUS = 4.6;
var EARTH_POSITION = new THREE.Vector3(0, -5.4, -2.2);
...
//#endregion
//#region src/components/altiryn/three/Earth.tsx
var surfaceVertex = `
  varying vec2 vUv;
...
function Earth({ quality }) {
	...
	useFrame((_, delta) => {
		...
		if (planet.current) {
			const targetScale = chapterId === "orbit" ? THREE.MathUtils.lerp(1, .62, chapterProgress) : 1;
			const scale = THREE.MathUtils.lerp(planet.current.scale.x, targetScale, 1 - Math.exp(-2.5 * dt));
			planet.current.scale.setScalar(scale);
			planet.current.position.y = THREE.MathUtils.lerp(planet.current.position.y, targetScale < .1 ? -12 : 0, 1 - Math.exp(-2 * dt));
		}
	});
...
//#endregion
//#region src/components/altiryn/three/materials.ts
...
//#endregion
//#region src/components/altiryn/three/Spacecraft.tsx
...
function Part({ id, children, base = [
	...
	return /* @__PURE__ */ jsxs("group", {
		...
		children: [children, highlight && /* @__PURE__ */ jsx(Highlight, {
			active,
			args: highlight.args,
...
function Fasteners({ points, radius = .028 }) {
	return /* @__PURE__ */ jsxs(Instances, {
		limit: points.length,
		castShadow: true,
		children: [
			...
			/* @__PURE__ */ jsx("meshStandardMaterial", { ...MAT.alu }),
			points.map((point, index) => /* @__PURE__ */ jsx(Instance, {
				position: point,
				rotation: [
					Math.PI / 2,
					0,
		...
		children: [
			/* @__PURE__ */ jsxs("mesh", {
				...
				children: [/* @__PURE__ */ jsx("cylinderGeometry", { args: [
					...
					.62,
					12
				] }), /* @__PURE__ */ jsx("meshStandardMaterial", { ...MAT.aluDull })]
			}),
			/* @__PURE__ */ jsxs("mesh", {
				position: [
					side * .62,
					...
					children: [
						/* @__PURE__ */ jsxs("mesh", {
							...
							children: [/* @__PURE__ */ jsx("boxGeometry", { args: [
								...
								1.42,
								.055
							] }), /* @__PURE__ */ jsx("meshStandardMaterial", { ...MAT.pvBus })]
						}),
						/* @__PURE__ */ jsxs("mesh", {
							position: [
								0,
						...
						/* @__PURE__ */ jsxs(Instances, {
							limit: cells.length,
							children: [
								/* @__PURE__ */ jsx("boxGeometry", { args: [
									.132,
									.235,
									.006
								] }),
								...
								cells.map((cell, cellIndex) => /* @__PURE__ */ jsx(Instance, { position: cell }, cellIndex))
							]
						}),
						[
							-.44,
		...
		children: [
			/* @__PURE__ */ jsxs("mesh", {
				...
				children: [/* @__PURE__ */ jsx("boxGeometry", { args: [
					...
					1.1,
					.07
				] }), /* @__PURE__ */ jsx("meshStandardMaterial", { ...MAT.hullDark })]
			}),
			[-.78, .78].map((x) => /* @__PURE__ */ jsxs("mesh", {
				position: [
					x,
					0,
					-.02
					...
					children: [
						/* @__PURE__ */ jsxs("mesh", {
							...
							children: [/* @__PURE__ */ jsx("boxGeometry", { args: [
								...
								.26,
								.5
							] }), /* @__PURE__ */ jsx("meshStandardMaterial", { ...MAT.hull })]
						}),
						/* @__PURE__ */ jsxs("mesh", {
							position: [
								0,
							...
							children: [/* @__PURE__ */ jsx("boxGeometry", { args: [
								...
								.2,
								.01
							] }), /* @__PURE__ */ jsx("meshStandardMaterial", { ...MAT.composite })]
						}),
						/* @__PURE__ */ jsxs("mesh", {
							position: [
								.1,
							...
							children: [/* @__PURE__ */ jsx("boxGeometry", { args: [
								...
								.045,
								.02
							] }), /* @__PURE__ */ jsx("meshStandardMaterial", { ...MAT.gold })]
						}),
						/* @__PURE__ */ jsxs("mesh", {
							position: [
								-.1,
						...
						[-.13, .13].map((y) => /* @__PURE__ */ jsxs("mesh", {
							position: [
								0,
								y,
								.2
			...
			[-.46, .46].map((y) => /* @__PURE__ */ jsxs("mesh", {
				position: [
					0,
					y,
					.1
			...
			/* @__PURE__ */ jsxs("group", {
				...
				children: [/* @__PURE__ */ jsxs("mesh", { children: [/* @__PURE__ */ jsx("boxGeometry", { args: [
					...
					.12,
					.34
				] }), /* @__PURE__ */ jsx("meshStandardMaterial", { ...MAT.composite })] }), /* @__PURE__ */ jsxs("mesh", {
					position: [
						.4,
						.07,
						.1
...
function DockingPort() {
	const latches = useMemo(() => Array.from({ length: 8 }, (_, index) => index / 8 * Math.PI * 2), []);
	return /* @__PURE__ */ jsxs(Part, {
		id: "docking",
		base: [
			0,
		...
		children: [
			...
			latches.map((angle) => /* @__PURE__ */ jsxs("group", {
				rotation: [
					0,
					0,
					angle
...
function Radiators() {
	return /* @__PURE__ */ jsxs(Part, {
		...
		children: [[-1, 1].map((side) => /* @__PURE__ */ jsxs("group", {
			position: [
				side * .86,
				0,
				0
			...
			children: [
				/* @__PURE__ */ jsxs("mesh", {
					...
					children: [/* @__PURE__ */ jsx("boxGeometry", { args: [
						...
						.035,
						1.3
					] }), /* @__PURE__ */ jsx("meshStandardMaterial", { ...MAT.radiator })]
				}),
				/* @__PURE__ */ jsxs(Instances, {
					limit: 9,
					children: [
						...
						/* @__PURE__ */ jsx("meshStandardMaterial", { ...MAT.aluDull }),
						Array.from({ length: 9 }, (_, index) => /* @__PURE__ */ jsx(Instance, { position: [
							(index - 4) * .085,
							.024,
							0
						] }, index))
			...
			children: [/* @__PURE__ */ jsx("cylinderGeometry", { args: [
				...
				1.7,
				8
			] }), /* @__PURE__ */ jsx("meshStandardMaterial", { ...MAT.cable })]
		})]
	});
}
function Communications() {
	return /* @__PURE__ */ jsxs(Part, {
		...
		children: [
			...
			[-.16, .16].map((x) => /* @__PURE__ */ jsxs("mesh", {
				position: [
					x,
					-.3,
					.14
...
function CableHarness() {
	const points = useMemo(() => [
		new THREE.Vector3(-.72, -.35, .86),
		new THREE.Vector3(-.3, -.52, .92),
		new THREE.Vector3(.25, -.52, .92),
		new THREE.Vector3(.66, -.6, .86)
	], []);
	const curve = useMemo(() => new THREE.CatmullRomCurve3(points), [points]);
	return /* @__PURE__ */ jsxs("mesh", { children: [/* @__PURE__ */ jsx("tubeGeometry", { args: [
		curve,
		28,
		.018,
		6,
		...
		children: [
			...
			/* @__PURE__ */ jsxs("mesh", {
				...
				children: [/* @__PURE__ */ jsx("cylinderGeometry", { args: [
					...
					.03,
					20
				] }), /* @__PURE__ */ jsx("meshStandardMaterial", { ...MAT.optic })]
			}),
			[-.24, .24].map((x) => /* @__PURE__ */ jsxs("group", {
				position: [
					x,
					-.08,
					.12
				...
				children: [/* @__PURE__ */ jsxs("mesh", { children: [/* @__PURE__ */ jsx("boxGeometry", { args: [
					...
					.1,
					.14
				] }), /* @__PURE__ */ jsx("meshStandardMaterial", { ...MAT.hullDark })] }), /* @__PURE__ */ jsxs("mesh", {
					position: [
						0,
						0,
						.08
		...
		children: [
			/* @__PURE__ */ jsxs("mesh", {
				...
				children: [/* @__PURE__ */ jsx("boxGeometry", { args: [
					...
					1.42,
					.08
				] }), /* @__PURE__ */ jsx("meshStandardMaterial", { ...MAT.shield })]
			}),
			/* @__PURE__ */ jsxs("mesh", {
				position: [
					0,
...
function Bus() {
	...
	return /* @__PURE__ */ jsxs(Part, {
		...
		children: [
			...
			[-1, 1].map((side) => /* @__PURE__ */ jsxs("group", {
				position: [
					side * 1.07,
					0,
					0
			...
			].map(([x, y, z]) => /* @__PURE__ */ jsxs("group", {
				position: [
					x ?? 0,
					y ?? 0,
					z ?? 0
				],
				children: [/* @__PURE__ */ jsxs("mesh", { children: [/* @__PURE__ */ jsx("cylinderGeometry", { args: [
					.05,
					.075,
					.14,
					12
				] }), /* @__PURE__ */ jsx("meshStandardMaterial", { ...MAT.aluDull })] }), /* @__PURE__ */ jsxs("mesh", {
					position: [
						0,
						-.09,
						0
			...
			/* @__PURE__ */ jsx(Fasteners, { points: fasteners }),
			/* @__PURE__ */ jsxs("mesh", {
				position: [
					.72,
					-.6,
			...
			/* @__PURE__ */ jsx(CableHarness, {}),
			[-1, 1].flatMap((x) => [-1, 1].map((y) => /* @__PURE__ */ jsxs("mesh", {
				position: [
					x * .86,
					y * .68,
					.83
...
function Spacecraft({ visible, deploy, charge }) {
	...
	useFrame((_, delta) => {
		...
		const orbitScale = chapterId === "orbit" ? THREE.MathUtils.lerp(.085, .42, chapterProgress) : 1;
	...
	return /* @__PURE__ */ jsxs("group", {
		...
		scale: .085,
		children: [
			(selected || hovered) && /* @__PURE__ */ jsx("pointLight", {
				position: [
					0,
					.5,
					2.4
			...
			/* @__PURE__ */ jsx(Bus, {}),
			/* @__PURE__ */ jsx(BatteryBay, { charge }),
			/* @__PURE__ */ jsx(DockingPort, {}),
			/* @__PURE__ */ jsx(Radiators, {}),
			/* @__PURE__ */ jsx(Communications, {}),
			/* @__PURE__ */ jsx(Avionics, {}),
			/* @__PURE__ */ jsx(Navigation, {}),
			/* @__PURE__ */ jsx(Shielding, {}),
			/* @__PURE__ */ jsxs(Part, {
				id: "solar",
				highlight: {
					args: [
				...
				children: [/* @__PURE__ */ jsx(SolarWing, {
					side: -1,
					deploy
				}), /* @__PURE__ */ jsx(SolarWing, {
					side: 1,
					deploy
				})]
			})
...
//#endregion
//#region src/components/altiryn/three/Capsule.tsx
...
function ReturnCapsule() {
	...
	const target = useMemo(() => new THREE.Vector3(2.4, -.6, 6.2), []);
	const heat = useRef(0);
	const visible = [
		"thermal",
		"return",
	...
	useFrame((state, delta) => {
		...
		group.current.rotation.x = THREE.MathUtils.lerp(group.current.rotation.x, entry.heat > .5 ? -.7 : 0, 1 - Math.exp(-2 * dt));
	...
	return /* @__PURE__ */ jsxs("group", {
		...
		children: [
			...
			[
				...
				.5,
				.66
			].map((radius, index) => /* @__PURE__ */ jsxs("mesh", {
				position: [
					0,
					-.24 - index * .06,
					0
...
//#endregion
//#region src/components/altiryn/three/Photons.tsx
var COUNT = 240;
...
function Photons({ active, flow }) {
	...
	useFrame((state, delta) => {
		...
		for (let i = 0; i < COUNT; i += 1) {
			...
			if (t < .62) {
				...
				y = THREE.MathUtils.lerp(from.y, .3 + (seed - .5) * 1.2, k);
				z = THREE.MathUtils.lerp(from.z, (seed - .5) * .6, k);
			} else if (t < .82) {
				const k = (t - .62) / .2;
				x = THREE.MathUtils.lerp(wingX, .72, k);
				y = THREE.MathUtils.lerp(.3 + (seed - .5) * 1.2, -.6, k);
				z = THREE.MathUtils.lerp((seed - .5) * .6, .85, k);
			} else {
				const k = (t - .82) / .18;
				x = THREE.MathUtils.lerp(.72, (seed - .5) * 1.1, k);
				y = THREE.MathUtils.lerp(-.6, -.25, k);
				z = THREE.MathUtils.lerp(.85, .72, k);
			}
			array[i * 3] = x;
	...
	return /* @__PURE__ */ jsx("points", {
		...
		geometry,
		visible: active,
		children: /* @__PURE__ */ jsx("pointsMaterial", {
			size: .055,
			color: "#ffd89a",
			transparent: true,
			opacity: 0,
...
//#endregion
//#region src/components/altiryn/three/CameraRig.tsx
...
function CameraRig() {
	...
	useFrame((state, delta) => {
		...
		desiredPosition.set(THREE.MathUtils.lerp(shot.position[0], next.position[0], blend), THREE.MathUtils.lerp(shot.position[1], next.position[1], blend), THREE.MathUtils.lerp(shot.position[2], next.position[2], blend));
		desiredLook.set(THREE.MathUtils.lerp(shot.look[0], next.look[0], blend), THREE.MathUtils.lerp(shot.look[1], next.look[1], blend), THREE.MathUtils.lerp(shot.look[2], next.look[2], blend));
		...
		if (selected) {
			...
			desiredPosition.copy(focus).add(offset).add(new THREE.Vector3(.8, .7, 2.6));
		}
...
//#endregion
//#region src/components/altiryn/World.tsx
...
function OrbitTrack({ quality }) {
	...
	const track = useMemo(() => {
		const points = new THREE.EllipseCurve(0, 0, EARTH_RADIUS * 1.62, EARTH_RADIUS * 1.62, 0, Math.PI * 2).getPoints(160).map((point) => new THREE.Vector3(point.x, 0, point.y));
	...
	return /* @__PURE__ */ jsxs("group", {
		...
		visible,
		children: [/* @__PURE__ */ jsxs("line", { children: [/* @__PURE__ */ jsx("primitive", {
			object: track,
			attach: "geometry"
...
function GroundLoop() {
	...
	useFrame((_, delta) => {
		...
		const scale = THREE.MathUtils.lerp(group.current.scale.x, target, 1 - Math.exp(-2.8 * Math.min(delta, .05)));
		group.current.scale.setScalar(scale);
	});
	return /* @__PURE__ */ jsxs("group", {
		ref: group,
		...
		visible,
		scale: .001,
		children: [stations.map((station, index) => /* @__PURE__ */ jsxs("group", {
			position: [
				(index - 2) * .62,
				0,
				0
...
function SceneContent({ quality }) {
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [
		...
		quality === "high" && /* @__PURE__ */ jsx("directionalLight", {
			position: [
				6,
				-4,
				-8
		...
		quality === "high" && /* @__PURE__ */ jsx("pointLight", {
			position: [
				0,
				-3,
				4
		...
		/* @__PURE__ */ jsx(Earth, { quality }),
		/* @__PURE__ */ jsx(OrbitTrack, { quality }),
		/* @__PURE__ */ jsx(Spacecraft, {
			visible: spacecraftVisible,
			deploy,
			charge
		}),
		/* @__PURE__ */ jsx(Photons, {
			active: [
				"machine",
				"energy",
				"storage"
		...
		/* @__PURE__ */ jsx(ReturnCapsule, {}),
		/* @__PURE__ */ jsx(GroundLoop, {}),
...
function World() {
	...
	return /* @__PURE__ */ jsx("div", {
		...
		children: /* @__PURE__ */ jsxs(Canvas, {
			...
			children: [/* @__PURE__ */ jsx(PerformanceMonitor, {
				bounds: () => [30, 58],
				...
				fallback: null,
				children: /* @__PURE__ */ jsx(SceneContent, { quality })
			})]
		})
	});
}
...
//#endregion
//#region src/components/altiryn/EngineeringLab.tsx
var MODULES = {
	orbit: {
...
function Parameter({ label, value, unit, min, max, step, onChange }) {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("span", { children: label }), /* @__PURE__ */ jsxs("strong", { children: [
...
function Insight({ label, children }) {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("small", { children: label }), /* @__PURE__ */ jsx("p", { children })]
	});
}
function EngineeringLab() {
	...
	const content = {
		orbit: {
			...
			controls: /* @__PURE__ */ jsx(Parameter, {
				label: "Altitude",
				value: altitude,
				unit: "km",
				min: 200,
			...
			result: /* @__PURE__ */ jsxs(Fragment, { children: [
				/* @__PURE__ */ jsxs("b", { children: [orbit.velocity.toFixed(2), " km/s"] }),
				/* @__PURE__ */ jsxs("b", { children: [orbit.periodMinutes.toFixed(1), " min"] }),
				/* @__PURE__ */ jsxs("b", { children: [orbit.orbitsPerDay.toFixed(1), " orbits/day"] })
			] }),
			visual: /* @__PURE__ */ jsxs("div", {
				className: "lab-orbit-visual",
				children: [
					/* @__PURE__ */ jsx("i", {}),
					/* @__PURE__ */ jsx("span", { children: "EARTH" }),
					/* @__PURE__ */ jsxs("b", { children: [altitude.toLocaleString(), " KM"] })
				]
			})
		},
		solar: {
			equation: "P = A × 1,361 W/m² × η",
			controls: /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Parameter, {
			...
			result: /* @__PURE__ */ jsxs(Fragment, { children: [
				/* @__PURE__ */ jsxs("b", { children: [solar.powerKw.toFixed(2), " kW"] }),
				/* @__PURE__ */ jsxs("b", { children: [solar.dayMwh.toFixed(3), " MWh/day"] }),
				/* @__PURE__ */ jsxs("b", { children: [solar.yearMwh.toFixed(1), " MWh/year"] })
			] }),
			visual: /* @__PURE__ */ jsx("div", {
				className: "lab-energy-visual",
				children: Array.from({ length: 24 }, (_, index) => /* @__PURE__ */ jsx("i", {}, index))
			})
		},
		battery: {
			equation: "m = E ÷ ρₑ",
			...
			result: /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsxs("b", { children: [batteryMass.toFixed(0), " kg"] }), /* @__PURE__ */ jsxs("b", { children: [(batteryMass / 1e3).toFixed(2), " tonnes"] })] }),
			visual: /* @__PURE__ */ jsx("div", {
				className: "lab-battery-visual",
				children: Array.from({ length: 12 }, (_, index) => /* @__PURE__ */ jsx("i", {}, index))
			})
		},
		thermal: {
			equation: "P = εσAT⁴",
			...
			result: /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsxs("b", { children: [thermalKw.toFixed(2), " kW"] }), /* @__PURE__ */ jsx("span", { children: "ε 0.90 · A 12 m²" })] }),
			visual: /* @__PURE__ */ jsxs("div", {
				className: "lab-thermal-visual",
				children: [/* @__PURE__ */ jsx("i", { style: { transform: `scaleX(${(temperature - 240) / 120})` } }), /* @__PURE__ */ jsx("span", { children: "RADIATIVE HEAT REJECTION" })]
			})
		},
		mass: {
			equation: "mₜ = Σmᵢ   ·   F = ma",
			result: /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("b", { children: "8,500 kg" }), /* @__PURE__ */ jsx("b", { children: "≈250 kN at 3g" })] }),
			visual: /* @__PURE__ */ jsx("div", {
				className: "lab-mass-visual",
				children: masses.map(([name, mass]) => /* @__PURE__ */ jsxs("div", { children: [
					/* @__PURE__ */ jsx("span", { children: name }),
					/* @__PURE__ */ jsx("i", { style: { width: `${mass / 47.51}%` } }),
					/* @__PURE__ */ jsxs("b", { children: [mass.toLocaleString(), " kg"] })
				] }, name))
			})
		},
		fleet: {
			...
			result: /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsxs("b", { children: [(solar.powerKw * fleet / 1e3).toFixed(2), " MW ideal"] }), /* @__PURE__ */ jsxs("b", { children: [(solar.dayMwh * fleet).toFixed(1), " MWh/day"] })] }),
			visual: /* @__PURE__ */ jsx("div", {
				className: "lab-fleet-visual",
				children: Array.from({ length: 40 }, (_, index) => /* @__PURE__ */ jsx("i", { className: index < Math.ceil(fleet / 25) ? "active" : "" }, index))
			})
		},
		economics: {
			equation: "$35M + $50M + $135M + $105M",
			result: /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("b", { children: "$325M" }), /* @__PURE__ */ jsx("b", { children: "≈$56.8/kWh" })] }),
			visual: /* @__PURE__ */ jsx("div", {
				...
				children: [
					...
					["OPERATIONS", 135],
					["MAINTENANCE", 105]
				].map(([name, value]) => /* @__PURE__ */ jsxs("div", { children: [
					/* @__PURE__ */ jsx("span", { children: name }),
					/* @__PURE__ */ jsx("i", { style: { width: `${Number(value) / 1.35}%` } }),
	...
	return /* @__PURE__ */ jsx("div", {
		...
		children: /* @__PURE__ */ jsxs(Tabs, {
			...
			children: [/* @__PURE__ */ jsx(TabsList, {
				...
				children: Object.keys(MODULES).map((tab) => /* @__PURE__ */ jsx(TabsTrigger, {
					value: tab,
					children: tab
				}, tab))
			}), Object.keys(MODULES).map((tab) => /* @__PURE__ */ jsxs(TabsContent, {
				value: tab,
				className: "lab-module",
				children: [
					/* @__PURE__ */ jsxs("div", {
						className: "lab-context",
						children: [/* @__PURE__ */ jsx(Insight, {
							label: "WHAT IS THIS?",
							children: MODULES[tab].what
						}), /* @__PURE__ */ jsx(Insight, {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsxs("div", {
								...
								children: [
									/* @__PURE__ */ jsx("small", { children: "CALCULATION" }),
									/* @__PURE__ */ jsx("h3", { children: content[tab].equation }),
									/* @__PURE__ */ jsx("p", { children: MODULES[tab].how }),
									content[tab].controls
								]
							}),
							/* @__PURE__ */ jsxs("div", {
								className: "result-stack",
								children: [/* @__PURE__ */ jsx("small", { children: "LIVE RESULT" }), content[tab].result]
							}),
							/* @__PURE__ */ jsx("div", {
...
//#endregion
//#region src/components/altiryn/ScientificReadouts.tsx
var flow = [
	"SUN",
	"PV ARRAY",
	"DC BUS",
...
function ScientificReadout({ chapter }) {
	if (chapter === "question" || chapter === "earth") return /* @__PURE__ */ jsxs("aside", {
	...
	if (chapter === "orbit") return /* @__PURE__ */ jsxs("aside", {
		className: "science-readout orbit-readout",
		"aria-label": "Orbital mechanics readout",
		children: [
			/* @__PURE__ */ jsxs("div", {
				className: "orbit-diagram",
				children: [/* @__PURE__ */ jsx("i", {}), /* @__PURE__ */ jsx("span", { children: "r = 6,871 km" })]
			}),
			/* @__PURE__ */ jsx(Scale, {
				label: "ALTITUDE",
				value: "500 km",
	...
	if (chapter === "energy") return /* @__PURE__ */ jsxs("aside", {
		className: "science-readout conversion-readout",
		"aria-label": "Energy conversion chain",
		children: [
			flow.slice(0, 4).map((item, index) => /* @__PURE__ */ jsxs("span", { children: [item, index < 3 && /* @__PURE__ */ jsx("i", { children: "→" })] }, item)),
			/* @__PURE__ */ jsx(Scale, {
	...
	if (chapter === "storage" || chapter === "thermal") return /* @__PURE__ */ jsxs("aside", {
		className: "science-readout storage-readout",
		"aria-label": "Battery and thermal readout",
		children: [
			/* @__PURE__ */ jsx("div", {
				className: "battery-cutaway",
				children: Array.from({ length: 12 }, (_, i) => /* @__PURE__ */ jsx("i", {}, i))
			}),
			/* @__PURE__ */ jsx(Scale, {
	...
	if (chapter === "operations") return /* @__PURE__ */ jsx("aside", {
		className: "science-readout system-flow",
		"aria-label": "System operations loop",
		children: flow.map((item, index) => /* @__PURE__ */ jsxs("span", { children: [/* @__PURE__ */ jsx("b", { children: String(index + 1).padStart(2, "0") }), item] }, item))
	});
	if (chapter === "fleet") return /* @__PURE__ */ jsxs("aside", {
	...
	if (chapter === "economics") return /* @__PURE__ */ jsxs("aside", {
		...
		children: [
			[
				...
				/* @__PURE__ */ jsx("span", { children: name }),
				/* @__PURE__ */ jsx("i", { style: { flexGrow: value } }),
				/* @__PURE__ */ jsxs("b", { children: [
					"$",
					value,
					"M"
			...
			/* @__PURE__ */ jsx("strong", { children: "$325M · ≈$56.8/kWh" }),
			/* @__PURE__ */ jsx("small", { children: "THESIS ESTIMATE · PRESENTLY DIFFICULT" })
		]
	});
	if (chapter === "risk") return /* @__PURE__ */ jsx("aside", {
		className: "science-readout risk-matrix",
		"aria-label": "Conceptual risk register",
		children: risks.map((risk, index) => /* @__PURE__ */ jsxs("span", {
			className: index < 4 ? "high" : index < 8 ? "medium" : "low",
			children: [/* @__PURE__ */ jsx("i", { children: String(index + 1).padStart(2, "0") }), risk]
		}, risk))
	});
	if (chapter === "feasibility") return /* @__PURE__ */ jsx("aside", {
		...
		].map(([name, state], index) => /* @__PURE__ */ jsxs("div", { children: [
			/* @__PURE__ */ jsx("span", { children: name }),
			/* @__PURE__ */ jsx("i", { children: /* @__PURE__ */ jsx("b", { style: { width: `${25 + index * 14}%` } }) }),
			/* @__PURE__ */ jsx("small", { children: state })
		] }, name))
	});
	if (chapter === "future") return /* @__PURE__ */ jsxs("aside", {
		className: "science-readout roadmap-readout",
		"aria-label": "Research roadmap",
		children: [
			/* @__PURE__ */ jsxs("span", { children: [/* @__PURE__ */ jsx("b", { children: "NEAR" }), "CAD · SIMULATION · DOCKING TESTS"] }),
			/* @__PURE__ */ jsxs("span", { children: [/* @__PURE__ */ jsx("b", { children: "MEDIUM" }), "EXPERIMENTAL SATELLITE · EXCHANGE"] }),
			/* @__PURE__ */ jsxs("span", { children: [/* @__PURE__ */ jsx("b", { children: "LONG" }), "CONSTELLATIONS · ROBOTIC SERVICING"] }),
			/* @__PURE__ */ jsxs("span", { children: [/* @__PURE__ */ jsx("b", { children: "BEYOND" }), "LUNAR · MARS · ORBITAL INDUSTRY"] })
		]
	});
	if (chapter === "machine") {
		...
		return /* @__PURE__ */ jsxs("aside", {
			...
			}), /* @__PURE__ */ jsx("div", { children: masses.slice(0, 5).map(([name, mass]) => /* @__PURE__ */ jsxs("span", { children: [
				/* @__PURE__ */ jsx("b", { children: name }),
				/* @__PURE__ */ jsx("i", { style: { width: `${mass / 52}%` } }),
				/* @__PURE__ */ jsx("small", { children: mass.toLocaleString() })
			] }, name)) })]
		});
	}
	return null;
...
//#endregion
//#region src/components/altiryn/ThesisPrimer.tsx
var architecture = [
	"SOLAR GENERATION",
	"MODULAR BATTERY",
	"AUTONOMOUS EXCHANGE",
...
function ArchitectureLoop() {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx("span", { children: "TRADITIONAL CONCEPT" }), /* @__PURE__ */ jsx("b", { children: "SOLAR GENERATION → WIRELESS TRANSMISSION → EARTH RECEIVER" })]
		}), /* @__PURE__ */ jsx("div", {
			className: "return-path",
			children: architecture.map((item, index) => /* @__PURE__ */ jsxs("div", { children: [
				/* @__PURE__ */ jsx("i", { children: String(index + 1).padStart(2, "0") }),
				/* @__PURE__ */ jsx("b", { children: item }),
				index < architecture.length - 1 && /* @__PURE__ */ jsx("span", { children: "→" })
			] }, item))
		})]
	});
}
function EcosystemLayers() {
	return /* @__PURE__ */ jsx("div", {
		...
		children: layers.map(([title, text], index) => /* @__PURE__ */ jsxs("div", { children: [
			/* @__PURE__ */ jsx("i", { children: String(index + 1).padStart(2, "0") }),
...
function SystemsMatrix() {
	return /* @__PURE__ */ jsx("div", {
		...
		children: domains.map(([title, text]) => /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("b", { children: title }), /* @__PURE__ */ jsx("span", { children: text })] }, title))
	});
}
function ThesisNetwork() {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx("small", { children: "ALTIRYN" }), /* @__PURE__ */ jsx("b", { children: "INTEGRATED SYSTEM" })]
		}), network.map(([label, target], index) => /* @__PURE__ */ jsx(Button, {
			variant: "ghost",
...
function MinuteSequence() {
	return /* @__PURE__ */ jsx("div", {
		...
		children: [
			...
			"RELAUNCH",
			"ORBIT"
		].map((item, index) => /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("i", { children: String(index + 1).padStart(2, "0") }), /* @__PURE__ */ jsx("b", { children: item })] }, item))
	});
}
//#endregion
//#region src/components/altiryn/ChapterBrief.tsx
var briefs = {
	question: {
...
function ChapterBrief({ id, fallback }) {
	...
	if (!brief) return /* @__PURE__ */ jsx("p", { children: fallback });
	return /* @__PURE__ */ jsx("div", {
		...
		].map(([label, text]) => /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("small", { children: label }), /* @__PURE__ */ jsx("p", { children: text })] }, label))
	});
}
//#endregion
//#region src/components/altiryn/Sidebar.tsx
...
function Sidebar({ open, onClose }) {
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsxs("aside", {
		...
		children: [
			...
			expanded && /* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						currentChapter.summary && /* @__PURE__ */ jsx("div", {
			...
			mode === "chapters" ? /* @__PURE__ */ jsx("nav", {
				className: "side-nav-list",
				"aria-label": "Thesis chapters",
				children: chapters.map((item, index) => /* @__PURE__ */ jsxs("button", {
					...
					children: [
						...
						index === chapter && /* @__PURE__ */ jsx("span", {
				...
				children: SYSTEM_ENTRIES.map((entry) => {
					...
					return /* @__PURE__ */ jsxs("button", {
						...
						}), expanded && /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsxs("div", {
...
//#endregion
//#region src/components/altiryn/Overlay.tsx
var cycleStates = [
	"CHARGE",
	"TRANSFER",
	"SEPARATE",
...
function SidebarToggle({ open, onToggle }) {
	...
	return /* @__PURE__ */ jsx(Button, {
		...
		onClick: onToggle,
		children: open ? /* @__PURE__ */ jsx(X, {}) : /* @__PURE__ */ jsx("span", {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsx(Button, {
				...
				onClick: onToggle,
				children: open ? /* @__PURE__ */ jsx(X, {}) : /* @__PURE__ */ jsx(Search, {})
			}),
			!open && /* @__PURE__ */ jsx("kbd", {
			...
			open && /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [
						query && results.length === 0 && /* @__PURE__ */ jsxs("div", {
							className: "search-empty",
							children: [/* @__PURE__ */ jsx("p", { children: /* @__PURE__ */ jsx("strong", { children: "No matches found" }) }), /* @__PURE__ */ jsx("p", { children: "Try searching for chapters, subsystems, equations or key figures." })]
						}),
						query && results.length > 0 && /* @__PURE__ */ jsx("div", {
							className: "search-results",
							children: Object.entries(resultsByTag).map(([tag, items]) => /* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("h4", {
									...
									children: [/* @__PURE__ */ jsx("b", { children: item.title }), /* @__PURE__ */ jsx("span", { children: item.description })]
								}, item.id))]
							}, tag))
						}),
							...
							children: [
								...
								/* @__PURE__ */ jsx("div", {
									...
									children: [
										...
										children: [/* @__PURE__ */ jsx("strong", { children: item.query }), /* @__PURE__ */ jsx("small", { children: item.label })]
									}, item.query))
								}),
								/* @__PURE__ */ jsx("p", {
									className: "search-hint",
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsxs("p", { children: [
										...
										" to open this panel"
									] }), /* @__PURE__ */ jsxs("p", { children: [/* @__PURE__ */ jsx("code", { children: "ESC" }), " to close"] })]
								})
							]
						})
					]
	...
	return /* @__PURE__ */ jsxs("aside", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs(Button, {
				...
				children: [/* @__PURE__ */ jsx(Maximize2, {}), exploded ? "ASSEMBLE" : "EXPLODE"]
			}), /* @__PURE__ */ jsx(Button, {
				variant: "ghost",
				size: "icon",
			...
			children: [
				...
				/* @__PURE__ */ jsx("h3", { children: system.label }),
				[
					["WHAT IT IS", system.what],
					["WHAT IT DOES", system.does],
					["WHY IT EXISTS", system.why],
					["ENGINEERING CHALLENGE", system.challenge]
				].map(([title, copy]) => /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("small", { children: title }), /* @__PURE__ */ jsx("p", { children: copy })] }, title))
			]
		}) : /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("h3", { children: "Rotate · zoom · pan" }),
				/* @__PURE__ */ jsx("p", { children: "Select any colored subsystem to inspect its engineering role." })
			]
		})]
	});
}
function CycleControl() {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs(Button, {
			variant: "outline",
			onClick: run,
			children: [cycle >= 0 && cycle < 10 ? /* @__PURE__ */ jsx(Pause, {}) : /* @__PURE__ */ jsx(Play, {}), cycle >= 0 && cycle < 10 ? "STOP CYCLE" : "RUN SYSTEM CYCLE"]
		}), /* @__PURE__ */ jsx("div", {
			className: "cycle-track",
			children: cycleStates.map((state, index) => /* @__PURE__ */ jsx("span", {
...
function DockingTelemetry() {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("p", {
			...
			/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("dt", { children: "RANGE" }), /* @__PURE__ */ jsxs("dd", { children: [distance.toFixed(1), " m"] })] }),
			/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("dt", { children: "REL. VELOCITY" }), /* @__PURE__ */ jsxs("dd", { children: [(distance > 20 ? 1.4 : distance * .02).toFixed(2), " m/s"] })] }),
			/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("dt", { children: "ALIGNMENT" }), /* @__PURE__ */ jsxs("dd", { children: [(distance > 20 ? 2.4 : .2).toFixed(1), "°"] })] }),
			/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("dt", { children: "STATE" }), /* @__PURE__ */ jsx("dd", {
				className: "live",
				children: status
			})] })
		] })]
...
function EnergyMath() {
	return /* @__PURE__ */ jsxs("div", {
		className: "equation",
		children: [
			/* @__PURE__ */ jsx("span", { children: "100 m²" }),
			/* @__PURE__ */ jsx("i", { children: "×" }),
			/* @__PURE__ */ jsx("span", { children: "1361 W/m²" }),
			/* @__PURE__ */ jsx("i", { children: "×" }),
			/* @__PURE__ */ jsx("span", { children: "32%" }),
			/* @__PURE__ */ jsx("i", { children: "=" }),
			/* @__PURE__ */ jsx("strong", { children: "43.55 kW" }),
			/* @__PURE__ */ jsx("small", { children: "IDEALIZED · CONTINUOUS OUTPUT ASSUMPTION" })
		]
	});
}
function BatteryMath() {
	...
	return /* @__PURE__ */ jsxs("div", {
		className: "equation",
		children: [
			/* @__PURE__ */ jsx("span", { children: "1.045 MWh" }),
			/* @__PURE__ */ jsx("i", { children: "÷" }),
			/* @__PURE__ */ jsx("span", { children: "220 Wh/kg" }),
			/* @__PURE__ */ jsx("i", { children: "=" }),
			/* @__PURE__ */ jsx("strong", { children: "4,751 kg" }),
			/* @__PURE__ */ jsx("div", {
				className: "charge-rail",
				children: /* @__PURE__ */ jsx("i", { style: { transform: `scaleX(${charge})` } })
			}),
			/* @__PURE__ */ jsxs("small", { children: [Math.round(charge * 100), "% STATE OF CHARGE · SIMULATED BMS"] })
		]
	});
}
function PartReadout() {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("b", { children: system.label }), /* @__PURE__ */ jsx("span", { children: hovered && !selected ? "CLICK TO INSPECT" : "SELECTED" })]
	});
}
function Overlay() {
	const chapter = useExperience((state) => state.chapter);
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [
		/* @__PURE__ */ jsxs("header", {
			...
			children: [/* @__PURE__ */ jsxs("a", {
				href: "#origin",
				className: "wordmark",
				children: ["ALTIRYN ", /* @__PURE__ */ jsx("span", { children: "— MADE BY TES" })]
			}), /* @__PURE__ */ jsxs("div", { children: [
				/* @__PURE__ */ jsx("span", {
					className: "concept-tag",
					children: "CONCEPTUAL STUDY · REV 1.0"
				}),
				/* @__PURE__ */ jsx(KnowledgeSearch, {
		...
		/* @__PURE__ */ jsx("main", {
			className: "story",
			children: chapters.map((item, index) => /* @__PURE__ */ jsxs("section", {
				id: item.id,
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							item.metric && /* @__PURE__ */ jsx("strong", {
								className: "chapter-metric",
								children: item.metric
							}),
							item.id === "energy" && /* @__PURE__ */ jsx(EnergyMath, {}),
							item.id === "storage" && /* @__PURE__ */ jsx(BatteryMath, {}),
							/* @__PURE__ */ jsxs("details", { children: [/* @__PURE__ */ jsx("summary", { children: "ENTER THE ENGINEERING" }), /* @__PURE__ */ jsx(ChapterBrief, {
								id: item.id,
								fallback: item.detail
							})] })
						]
					}),
					item.id === "architecture" && /* @__PURE__ */ jsx(ArchitectureLoop, {}),
					item.id === "ecosystem" && /* @__PURE__ */ jsx(EcosystemLayers, {}),
					item.id === "systems" && /* @__PURE__ */ jsx(SystemsMatrix, {}),
					item.id === "coverage" && /* @__PURE__ */ jsx(ThesisNetwork, {}),
					item.id === "minute" && /* @__PURE__ */ jsx(MinuteSequence, {}),
					/* @__PURE__ */ jsx(ScientificReadout, { chapter: item.id }),
					item.id === "machine" && /* @__PURE__ */ jsx(MachinePanel, {}),
					item.id === "return" && /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(CycleControl, {}), /* @__PURE__ */ jsx(DockingTelemetry, {})] }),
					item.id === "intelligence" && /* @__PURE__ */ jsxs("div", {
						className: "ai-flow",
						children: [
							/* @__PURE__ */ jsx("span", { children: "SENSORS" }),
							/* @__PURE__ */ jsx("i", { children: "↓" }),
							/* @__PURE__ */ jsx("span", { children: "TELEMETRY" }),
							/* @__PURE__ */ jsx("i", { children: "↓" }),
							/* @__PURE__ */ jsx("span", { children: "AI ANALYSIS" }),
							/* @__PURE__ */ jsx("i", { children: "↓" }),
							/* @__PURE__ */ jsx("span", { children: "DECISION" }),
							/* @__PURE__ */ jsx("i", { children: "↓" }),
							/* @__PURE__ */ jsx("span", { children: "ACTION" }),
							/* @__PURE__ */ jsx("small", { children: "SIMULATED" })
						]
					}),
					item.id === "engineering" && /* @__PURE__ */ jsx(EngineeringLab, {}),
					item.id === "conclusion" && /* @__PURE__ */ jsxs("div", {
						className: "credits",
						children: [
							/* @__PURE__ */ jsx("span", { children: "ALTIRYN" }),
							/* @__PURE__ */ jsx("span", { children: "CONCEPTUAL ENGINEERING STUDY" }),
							/* @__PURE__ */ jsx("strong", { children: "MADE BY TES" }),
							/* @__PURE__ */ jsx("i", { className: "credits-rule" }),
							/* @__PURE__ */ jsx("span", { children: "TEJES J" }),
							/* @__PURE__ */ jsx("span", { children: "REVISION 1.0 · JUNE 2026" })
						]
					})
				]
			}, item.id))
		}),
		/* @__PURE__ */ jsx(PartReadout, {}),
		/* @__PURE__ */ jsx("div", {
			className: "progress-rail",
			children: /* @__PURE__ */ jsx("i", { style: { transform: `scaleY(${(chapter + 1) / chapters.length})` } })
		})
	] });
}
//#endregion
//#region src/components/altiryn/AltirynExperience.tsx
function AltirynExperience() {
	return /* @__PURE__ */ jsxs("div", {
		className: "altiryn-experience",
		children: [/* @__PURE__ */ jsx(World, {}), /* @__PURE__ */ jsx(Overlay, {})]
	});
}
//#endregion
